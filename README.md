...
```
예) 질문: 직진 신호에 사거리에서 우회전을 하다가 빨간 불에 횡단보도를 건너는 사람을 치고 말았습니다. 
    응답: 최종 과실 비율 예측) 질문자 (30) : 보행자 (70)
          참고: 보행자나 차마는 신호기의 신호에 따라야 할 의무가 있으므로 이를 위반하며 보행자 신호등
          적색신호에 횡단을 개시한 보행자에게 일방적으로 과실을 물어야 할 것이나 보행자가 상대적 교통약자인
          점, 차량은 도로교통법 제 27조 제1항에 따른 일시정지 의무가 있는 점을 고려하여 보행자의 기본과실을
          70%로 정하였습니다. (...)
```
...
```
예) 속도를 위반한 채 직진 신호에 사거리에서 우회전을 하다가 빨간 불에 횡단보도를 건너는 사람을 치고 말았습니다.
    응답: 최종 과실 비율 예측) 질문자 (40) : 보행자 (60)
          참고: 보행자나 차마는 신호기의 신호에 따라야 할 의무가 있으므로 이를 위반하며 보행자 신호등
          적색신호에 횡단을 개시한 보행자에게 일방적으로 과실을 물어야 할 것이나 보행자가 상대적 교통약자인
          점, ... 그러나 질문자가 10km/h 이상 20km/h 미만의 제한속도 위반을 범한 것은 현저한 과실로서
          질문자의 과실을 10 % 가산할 수 있습니다. (...)
```
